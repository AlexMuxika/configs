...
static const char *fonts[]          = { "fontawesome-regular.sh:size=12" };
static const char dmenufont[]       = "fontawesome-regular.sh:size=12";
...
static const char *defaulttagapps[] = { "qutebrowser", NULL, NULL, NULL, "kdeconnect-sms", NULL, "onlyoffice-desktopeditors", NULL, NULL };
...
static const char *wallpaper[] = { "feh", "--bg-fill", "-z", "/home/muxika/Nextcloud/Pictures/Wallpaper/", NULL };
...
static const char *tweb[]  = { "tabbed", "-c", "surf", "-e", NULL };
static const char *wal[]  = { "wal", "-i", "/home/muxika/Nextcloud/Pictures/Wallpaper/", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = tterm } },
	...
	{ MODKEY|ShiftMask,                       XK_w,       spawn,         {.v = tweb } },
	{ MODKEY,                       XK_u,       spawn,         {.v = wal } }, 
};
